...
public class AggregationTest extends AbstractQueryTest {
    ...
    @Test
    public void Max() {
        assertEquals(Long.valueOf(5L), query.select(cat.weight.max()).fetchOne());
    }

    @Test
    public void Min() {
        assertEquals(Long.valueOf(2L), query.select(cat.weight.min()).fetchOne());
    }
    ...
    @Test
    public void Sum() {
        assertEquals(Long.valueOf(14L), query.select(cat.weight.sum()).fetchOne());
    }
